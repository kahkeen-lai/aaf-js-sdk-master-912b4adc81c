          ...
          providers: [
            {
              ...
              events: [
                {
                  url: 'https://xaaf-be-dev.att.com/mock/request/youi/302',
                  clientOutbound: [
                    {
                ...
                {
                  url: 'https://xaaf-be-dev.att.com/mock/request/youi/400',
                  clientOutbound: [
                    {
                      paramType: 'clientFormattedTimeStamp',
                      paramName: 'ClientTime'
            ...
            },
            {
              ...
              events: [
                {
                  url: 'https://xaaf-be-dev.att.com/mock/request/youi/timeout'
                }
              ]
            }
          ],
